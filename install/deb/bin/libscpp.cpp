							...
							if(newer[x+3] != 'b') {
								if(newer[x+3] != 'r') {
									if(newer[x+3] != 'f') {
												...
												if(exec1 == false) {
													cout << "ERROR syntax not executed in `com`" << endl;
													return 0;
												}
												if(exec2 == false) {
													cout << "ERROR syntax not executed in `com`" << endl;
				...
				if(newer[x] == 'f') {
					if(newer[x+1] == 'u') {
						if(newer[x+2] == 'n') {
												...
												if(exec1 == false) {
													cout << "ERROR syntax not executed  in `fun`" << endl;
													return 0;
												}
												if(exec2 == false) {
													cout << "ERROR syntax not executed  in `fun`" << endl;
